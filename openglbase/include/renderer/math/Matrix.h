...
public:
    ...
    */
    ...
    /**
    * Constructs a matrix initialized to one specified value.
    *
    */
    Matrix(float val);
    ...
    */
    static void createLookAt(const Vec3& eyePosition, const Vec3& targetPosition, const Vec3& up, Matrix* dst);
    ...
    * @param dst A matrix to store the result in.
    */
    static void createReflection(const physx::Plane& plane, Matrix* dst);
    ...
    * @param dst A matrix to store the result in.
    */
    static void createScale(const Vec3& scale, Matrix* dst);
    ...
    * @param dst A matrix to store the result in.
    */
    static void createRotation(const Vec3& axis, float angle, Matrix* dst);
    ...
    * @param dst A matrix to store the result in.
    */
    static void createTranslation(const Vec3& translation, Matrix* dst);
    ...
    * @param dst A matrix to store the result in.
    */
    void rotate(const Vec3& axis, float angle, Matrix* dst) const;
    ...
    * @param dst A matrix to store the result in.
    */
    void scale(const Vec3& s, Matrix* dst) const;
    ...
    * @param dst A matrix to store the result in.
    */
    void translate(const Vec3& t, Matrix* dst) const;
