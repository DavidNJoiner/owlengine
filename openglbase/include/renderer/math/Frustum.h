...
public:
    ...
    */
    const physx::Plane& getNear() const;
    ...
    */
    const physx::Plane& getFar() const;
    ...
    */
    const physx::Plane& getLeft() const;
    ...
    */
    const physx::Plane& getRight() const;
    ...
    */
    const physx::Plane& getBottom() const;
    ...
    */
    const physx::Plane& getTop() const;
    ...
    */
    bool intersects(const physx::BoundingSphere& sphere) const;
    ...
    */
    bool intersects(const physx::AABB& box) const;
    ...
    */
    float intersects(const physx::Plane& plane) const;
    ...
    *  and Plane::INTERSECTS_INTERSECTING if it intersects this plane.
    */
    float intersects(const physx::Ray& ray) const;
