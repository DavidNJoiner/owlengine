...
public:
    ...
    /**
        * Constructs a new vector initialized to a single values.
        *
        * @param p The x, y, z coordinate.
        */
    Vec3(float p);
     ...
     * @param dst The destination vector to store the result.
     */
    static void lerp(const Vec3& start, const Vec3& end, float t, Vec3* dst);
    ...
    /**
        ...
        */
    inline const Vec3 operator*(float x) const;
