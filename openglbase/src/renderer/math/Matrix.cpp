...
{
    set(val, val, val, val, val, val, val, val, val, val, val, val, val, val, val, val);
}
...
void Matrix::createLookAt(const Vec3& eyePosition, const Vec3& targetPosition, const Vec3& up, Matrix* dst)
{
...
void Matrix::createBillboard(const Vec3& objectPosition, const Vec3& cameraPosition,
    const Vec3& cameraUpVector, Matrix* dst)
{
...
void Matrix::createBillboardHelper(const Vec3& objectPosition, const Vec3& cameraPosition,
    const Vec3& cameraUpVector, const Vec3* cameraForwardVector,
    Matrix* dst)
{
...
void Matrix::createReflection(const physx::Plane& plane, Matrix* dst)
{
...
void Matrix::createScale(const Vec3& scale, Matrix* dst)
{
    ASSERT(dst);
...
void Matrix::createRotation(const Vec3& axis, float angle, Matrix* dst)
{
    ASSERT(dst);
...
void Matrix::createTranslation(const Vec3& translation, Matrix* dst)
{
    ASSERT(dst);
...
void Matrix::add(float scalar, Matrix* dst)
{
    ...
    MathFunc::addMatrix(m, scalar, dst->m);
}
...
void Matrix::add(const Matrix& m1, const Matrix& m2, Matrix* dst)
{
    ...
    MathFunc::addMatrix(m1.m, m2.m, dst->m);
}

bool Matrix::decompose(Vec3* scale, Quaternion* rotation, Vec3* translation) const
{
    if (translation)
    {
...
void Matrix::getScale(Vec3* scale) const
{
...
void Matrix::getTranslation(Vec3* translation) const
{
    decompose(NULL, NULL, translation);
}

void Matrix::getUpVector(Vec3* dst) const
{
    ASSERT(dst);
...
void Matrix::getDownVector(Vec3* dst) const
{
    ASSERT(dst);
...
void Matrix::getLeftVector(Vec3* dst) const
{
    ASSERT(dst);
...
void Matrix::getRightVector(Vec3* dst) const
{
    ASSERT(dst);
...
void Matrix::getForwardVector(Vec3* dst) const
{
    ASSERT(dst);
...
void Matrix::getBackVector(Vec3* dst) const
{
    ASSERT(dst);
...
void Matrix::multiply(const Matrix& m, float scalar, Matrix* dst)
{
    ...
    MathFunc::multiplyMatrix(m.m, scalar, dst->m);
}
...
void Matrix::multiply(const Matrix& m1, const Matrix& m2, Matrix* dst)
{
    ...
    MathFunc::multiplyMatrix(m1.m, m2.m, dst->m);
}
...
void Matrix::rotate(const Vec3& axis, float angle, Matrix* dst) const
{
    Matrix r;
...
void Matrix::scale(const Vec3& s, Matrix* dst) const
{
...
void Matrix::subtract(const Matrix& m1, const Matrix& m2, Matrix* dst)
{
    ...
    MathFunc::subtractMatrix(m1.m, m2.m, dst->m);
}

void Matrix::transformPoint(Vec3* point) const
{
    ASSERT(point);
    transformVector(point->x, point->y, point->z, 1.0f, point);
}

void Matrix::transformPoint(const Vec3& point, Vec3* dst) const
{
    transformVector(point.x, point.y, point.z, 1.0f, dst);
}

void Matrix::transformVector(Vec3* vector) const
{
    ASSERT(vector);
    transformVector(vector->x, vector->y, vector->z, 0.0f, vector);
}

void Matrix::transformVector(const Vec3& vector, Vec3* dst) const
{
    transformVector(vector.x, vector.y, vector.z, 0.0f, dst);
}

void Matrix::transformVector(float x, float y, float z, float w, Vec3* dst) const
{
    ASSERT(dst);

    MathFunc::transformVector4(m, x, y, z, w, (float*)dst);
}

void Matrix::transformVector(Vec4* vector) const
{
    ASSERT(vector);
    transformVector(*vector, vector);
}

void Matrix::transformVector(const Vec4& vector, Vec4* dst) const
{
    ASSERT(dst);

    MathFunc::transformVector4(m, (const float*)&vector, (float*)dst);
}
...
void Matrix::translate(const Vec3& t, Matrix* dst) const
{
...
void Matrix::transpose(Matrix* dst) const
{
    ...
    MathFunc::transposeMatrix(m, dst->m);
}